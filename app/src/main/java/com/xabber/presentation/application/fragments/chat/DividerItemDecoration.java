...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private ChatListFragment.ChatListAvatarState chatListOffsetMode = ChatListFragment.ChatListAvatarState.NOT_SPECIFIED;
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        if (chatListOffsetMode != ChatListFragment.ChatListAvatarState.NOT_SPECIFIED) {
            if (chatListOffsetMode == ChatListFragment.ChatListAvatarState.SHOW_AVATARS) {
                tempLeft += (int) (parent.getContext().getResources().getDisplayMetrics().density * 72f);
            } else if (chatListOffsetMode == ChatListFragment.ChatListAvatarState.DO_NOT_SHOW_AVATARS) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int bottom = Math.round(child.getTranslationY());
    ...
    public void getItemOffsets(@NotNull Rect outRect, @NotNull View view, @NotNull RecyclerView parent,
        ...
        if (chatListOffsetMode != ChatListFragment.ChatListAvatarState.NOT_SPECIFIED) { // i.e. we have specified the offset mode, meaning this is ChatList
            outRect.setEmpty();
            return;
        }
