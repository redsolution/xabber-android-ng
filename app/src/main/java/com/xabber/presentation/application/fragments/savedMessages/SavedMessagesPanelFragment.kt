...
class SavedMessagesPanelFragment : BaseFragment(R.layout.fragment_saved_messages_panel) {
    ...
    private fun setupOrientationLayout() {
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            if (requireActivity().supportFragmentManager.findFragmentById(R.id.application_container) !is SavedMessagesPanelFragment) {
            ...
            if (requireActivity().supportFragmentManager.findFragmentById(R.id.detail_container) !is SavedMessagesPanelFragment) {
                requireActivity().supportFragmentManager.beginTransaction()
                    .setReorderingAllowed(true)
            ...
            if (requireActivity().supportFragmentManager.findFragmentById(R.id.application_container) !is SavedMessagesFragment) {
                requireActivity().supportFragmentManager.beginTransaction()
                    .setReorderingAllowed(true)
...
//            })
    ...
    private fun showPopupMenu(view: View): Boolean {
        ...
        popup.menuInflater.inflate(R.menu.saved_messages_filter_menu, popup.menu)
