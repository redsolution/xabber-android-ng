...
import static com.xabber.utils.ExtentsionsKt.spToPxFloat;
...
public class MessageHeaderViewDecoration extends RecyclerView.ItemDecoration {
    ...
    private static final int backgroundDrawableHeight = dipToPx(24f, XabberApplication.Companion.applicationContext());
    private static final int backgroundDrawableXPadding = dipToPx(8f, XabberApplication.Companion.applicationContext());
    private static final int backgroundDrawableYMargin = dipToPx(3.64f, XabberApplication.Companion.applicationContext());
    ...
    private static final String unread = "Непрочитанные сообщения";
    ...
    public MessageHeaderViewDecoration(Context context) {
        ...
        paintFont.setTextSize(spToPxFloat(14f, XabberApplication.Companion.applicationContext()) + 1f);
