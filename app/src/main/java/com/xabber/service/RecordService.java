...
//                mRecorder.encoderInit(Constants.SampleRate.Companion._48000(), Constants.Channels.Companion.stereo(), Constants.Application.Companion.audio());
//                mRecorder.decoderInit(Constants.SampleRate.Companion._48000(), Constants.Channels.Companion.stereo());
//                mRecorder.encoderSetComplexity(Constants.Complexity.Companion.instance(10));
//                mRecorder.encoderSetBitrate(Constants.Bitrate.Companion.max());
